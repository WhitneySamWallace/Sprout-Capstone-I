      ...
      <div className="Landing-Page">
        ...
        <main role="main" className="main" id="home">
          <section className="about-section">
            ...
            <NavLink smooth to='/#sign-up' className="sign-up-button">Sign Up</NavLink>
          </section>
          <section className="info-section">
            <header role="banner">
              <h3>
                Sprout helps teachers deliver timely, goal-oriented, specific feedback to students.
              </h3>
            </header>
          ...
          <section className="demo-section">
            <div className="card demo-section-card">
              ...
              <NavLink to='/login' className="sign-up-button">Demo Login</NavLink>
            </div>
          </section>
